a.out: main.o insert.o sort_pointer_array.o myIO.o
	gcc -o a.out main.o insert.o sort_pointer_array.o myIO.o
myIO.o: myIO.c myIO.h struct.h
	gcc -c myIO.c
main.o: main.c insert.h sort_pointer_array.h struct.h myIO.h
	gcc -c main.c
