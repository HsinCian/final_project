...
button3 = tk.Button(window, text='Korean',bg='navy', command=kor).pack(padx=5, pady=10)
button4 = tk.Button(window, text='American',bg='seagreen', command=amr).pack(padx=5, pady=10)
button5 = tk.Button(window, text='Chinese',bg='purple', command=chi).pack(padx=5, pady=10)
